...
public class MainActivity extends AppCompatActivity {
    ...
    Spinner spcourses;
public static String NOTE_POSITION="com.example.notekeeper.NOTE_POSITION";
    public static String ORIGINAL_NOTE_COURSE_ID ="com.example.notekeeper.ORIGINAL_NOTE_COURSE_ID";
    public static String ORIGINAL_NOTE_TITLE="com.example.notekeeper.ORIGINAL_NOTE_TITLE";
    public static String ORIGINAL_NOTE_TEXT="com.example.notekeeper.ORIGINAL_NOTE_TEXT"
            ;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        spcourses=findViewById(R.id.spinner_courses);
    ...
    if(savedInstanceState==null){
        ...
        if(!mIsNewNote)
        dispplayNotes(spcourses, textNoteTitle, textNoteText);
        Log.d(TAG, "onCreate");
/*
    ...
    private void dispplayNotes(Spinner spcourses, EditText textNoteTitle, EditText textNoteText) {
    ...
    private void sendEmail() {
        CourseInfo course= (CourseInfo) spcourses.getSelectedItem();
        String subject=textNoteTitle.getText().toString();
        String text="Check out what i learned at Pluralsight \"" + course.getTitle() + "\" \n" + textNoteText.getText().toString();
